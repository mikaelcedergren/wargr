...
export class ArticleSlaughterhouseComponent {
  ...
  protected readonly meta = "June 6, 2026 · 5 min read · 1033 words";
  protected readonly kicker = "philosophy";
  protected readonly filed = "philosophy · conformity · herd · society · propaganda · consensus";
  protected readonly coda: WgQuote | null = {"hook":"I used to think the people running the slaughterhouse were the problem.","elab":"On our own, content and unresisting, we walk into the slaughterhouse."};
  protected readonly related: WgRelated[] = [{"slug":"whom-to-listen-to","title":"The one you should have listened to","dek":"When a hundred people agree about something and one person doesn't, the one person is usually wrong. Until they aren't, and the cost of having dismissed them has already been paid.","meta":"June 2026 · 5 min · Shared: consensus"},{"slug":"corruption","title":"How fear turns the good in us into corruption","dek":"Corruption rarely starts with a bad person. It starts with a good one who has too much to lose.","meta":"June 2026 · 3 min · Shared: courage"},{"slug":"stop-chasing-purpose","title":"Stop chasing purpose","dek":"The search for purpose is a trap most people walk into willingly. It ends only when they notice the search is the problem.","meta":"June 2026 · 2 min · Shared: narrative"}];
